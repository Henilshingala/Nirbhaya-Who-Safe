...
object SecurePreferences {
    ...
    fun setUserName(context: Context, name: String) {
        getInstance(context).edit().putString(KEY_USER_NAME, name).apply()
    }
    
    fun getUserName(context: Context): String {
        return getInstance(context).getString(KEY_USER_NAME, "") ?: ""
    }
    ...
    /**
     * Clear ALL secure preferences data
     * Used when logging out or clearing all app data
     */
